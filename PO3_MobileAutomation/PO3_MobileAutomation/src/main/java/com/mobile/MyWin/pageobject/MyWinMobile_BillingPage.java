...
public class MyWinMobile_BillingPage {

	final WebDriver driver;
	private Validator vc;
	
	
	public MyWinMobile_BillingPage(WebDriver driver) {
		this.driver = driver;
	...
	public void makePaymentAmount() throws InterruptedException {
		...
		vc.getMobileDriverUtils().elementAvailablity(Options, "Options");
		vc.getMobileDriverUtils().elementAvailablity(Historyoption, "Bills");
		vc.getMobileDriverUtils().clickMobileElement(CurrentBill, "CurrentBill");
	...
	@FindBy(id="message")
	public WebElement cardErrorMessage;
		...
		if(currentBalanceDue.getText().equals("$0.00")) {
			...
			vc.getMobileDriverUtils().clickMobileElement(continueButton, "Continue");
				...
				if (checkCardAvailability()) {
					...
					} else if (vc.getMobileDriverUtils().elementAvailablity(cardErrorMessage, "PopUp")) {
						Reporter.log(cardErrorMessage.getText().toUpperCase(), true);
	...
	public void paperlessBilling() {
		...
		vc.getMobileDriverUtils().clickMobileElement(MyWinMobile_BillingPage.Options, "Options-Menu");
