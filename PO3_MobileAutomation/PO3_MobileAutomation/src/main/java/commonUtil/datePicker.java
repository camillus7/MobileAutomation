...
public class datePicker {
    ...
    public void testDAtePicker(WebDriver driver) throws Exception{
...
//         
// 
//        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS); Thread.sleep(ValidationClass.getSleepVar3000());
