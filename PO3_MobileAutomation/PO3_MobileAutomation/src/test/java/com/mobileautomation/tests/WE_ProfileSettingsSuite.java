...
public class WE_ProfileSettingsSuite extends BaseSteps_android {
	...
	@Test
	public void weConnect_SetStartPage() throws Throwable {
	...
	@Test
	public void weConnect_SetShortcutToContact() throws Throwable {
		Menu menu = MenuFactory.getModule1MenuByTitle(module1AppMenu.Automation);
		myWinMobile_LoginPage.navigateTo_MywinHome(menu);
	...
	@Test
	public void weConnect_ProfileSettings() throws Throwable {
		Menu menu = MenuFactory.getModule1MenuByTitle(module1AppMenu.Automation);
		myWinMobile_LoginPage.navigateTo_MywinHome(menu);
