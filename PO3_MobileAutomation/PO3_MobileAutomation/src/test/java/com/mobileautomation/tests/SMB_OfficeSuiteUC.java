...
public class SMB_OfficeSuiteUC extends BaseSteps_android {
	...
	@Test
	public void smb_ContactAddFavorite() throws Throwable {
	...
	@Test
	public void smb_GroupsAddFavorite() throws Throwable {
		Menu menu = MenuFactory.getModule1MenuByTitle(module1AppMenu.BVN_User);
		myWinMobile_LoginPage.navigateTo_MywinHome(menu);
	...
	@Test
	public void smb_TabsFunctionality() throws Throwable {
		Menu menu = MenuFactory.getModule1MenuByTitle(module1AppMenu.BVN_User);
		myWinMobile_LoginPage.navigateTo_MywinHome(menu);
	...
	@Test
	public void smb_SearchCoworkers() throws Throwable {
		Menu menu = MenuFactory.getModule1MenuByTitle(module1AppMenu.BVN_User);
		myWinMobile_LoginPage.navigateTo_MywinHome(menu);
	...
	@Test
	public void smb_getMenuList() throws Throwable {
		Menu menu = MenuFactory.getModule1MenuByTitle(module1AppMenu.BVN_User);
		myWinMobile_LoginPage.navigateTo_MywinHome(menu);
	...
	@Test
	public void smb_CreateandDeleteGroup() throws Throwable {
		Menu menu = MenuFactory.getModule1MenuByTitle(module1AppMenu.BVN_User);
		myWinMobile_LoginPage.navigateTo_MywinHome(menu);
	...
	@Test
	public void smb_Orders() throws Throwable {
		Menu menu = MenuFactory.getModule1MenuByTitle(module1AppMenu.BVN_User);
		myWinMobile_LoginPage.navigateTo_MywinHome(menu);
		Reporter.log("User Story : AddFavorite", true);
		successMsgDesc = "";
